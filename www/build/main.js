...
var User = /** @class */ (function () {
    function User(name, username, telefone, 
        //public CPF: string,
        //public email: string,
        photo) {
        this.name = name;
...
var firebaseAppConfig = {
    apiKey: "AIzaSyCfnEZDN41jZxZch5HaONV_THyUa-3nKE4",
    authDomain: "topicosespeciaisionic.firebaseapp.com",
    databaseURL: "https://topicosespeciaisionic.firebaseio.com",
    storageBucket: "topicosespeciaisionic.appspot.com",
    messagingSenderId: "671808039513"
};
...
var ProgressBarComponent = /** @class */ (function () {
    ...
    ProgressBarComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'progress-bar',template:/*ion-inline-start:"C:\Users\Marco\ionic\src\components\progress-bar\progress-bar.html"*/'<div class="progress-outer">\n    <div class="progress-inner" [style.width]="progress + \'%\'">\n      {{ progress }}%\n    </div>\n  </div>'/*ion-inline-end:"C:\Users\Marco\ionic\src\components\progress-bar\progress-bar.html"*/
        }),
...
var MessageBoxComponent = /** @class */ (function () {
    ...
    MessageBoxComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'message-box',template:/*ion-inline-start:"C:\Users\Marco\ionic\src\components\message-box\message-box.html"*/'\n<div class="text" [ngClass]="{\'sender-background\': isFromSender}">\n  <p>{{ message.text }}</p>\n  <p class="timestamp"> {{ message.timestamp | date:\'dd/MM/y H:mm\' }} </p>\n</div>\n'/*ion-inline-end:"C:\Users\Marco\ionic\src\components\message-box\message-box.html"*/,
            host: {
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\Marco\ionic\src\app\app.html"*/'<ion-menu [content]="content" enabled="false" id="user-menu" persistence="true"> \n    <user-menu [user]="currentUser"> </user-menu>\n</ion-menu>\n<ion-nav #content [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\Users\Marco\ionic\src\app\app.html"*/
        }),
...
var CustomLoggedHeaderComponent = /** @class */ (function (_super) {
    ...
    CustomLoggedHeaderComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'custom-logged-header',template:/*ion-inline-start:"C:\Users\Marco\ionic\src\components\custom-logged-header\custom-logged-header.html"*/'\n<ion-navbar>\n\n    <button ion-button menuToggle="user-menu">\n        <ion-icon name="menu"></ion-icon>\n    </button>\n\n  <ion-title> {{title}} </ion-title>\n\n  <ion-buttons end>\n\n    <button ion-button icon-only (click)="onLogout()"> \n      <ion-icon name="exit"> </ion-icon>\n    </button>\n  </ion-buttons>\n\n\n</ion-navbar>'/*ion-inline-end:"C:\Users\Marco\ionic\src\components\custom-logged-header\custom-logged-header.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["a" /* AlertController */],
...
var UserInfoComponent = /** @class */ (function () {
    ...
    UserInfoComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'user-info',template:/*ion-inline-start:"C:\Users\Marco\ionic\src\components\user-info\user-info.html"*/'<div *ngIf="user">\n    <ion-avatar [ngClass]="{\'custom-background\': isMenu}">\n        <img class="round" [src]="user.photo || \'assets/imgs/no-photo.jpg\'">\n    </ion-avatar>\n  <h2 text-center>{{ user.name }}</h2>\n  <p text-center>@{{ user.username }}</p>\n</div>'/*ion-inline-end:"C:\Users\Marco\ionic\src\components\user-info\user-info.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], UserInfoComponent);
